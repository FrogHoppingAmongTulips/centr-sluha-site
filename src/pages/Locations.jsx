  ...
  return (
    <>
      <PageHero
        ...
        title="Наш центр слуха в Москве"
        text="Современный кабинет с точным оборудованием для диагностики, безбарьерной средой и командой сурдологов — приходите познакомиться."
      />
      ...
      <section className="section">
        <div className="container band">
          <div>
            <h2>Не получается приехать?</h2>
            <p className="lead">Мы проводим онлайн-консультации сурдолога и подскажем по телефону. Напишите нам — поможем с первым шагом.</p>
          </div>
