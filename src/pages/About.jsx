...
export default function About() {
  ...
  return (
    <>
      <Seo
        title="О центре"
        description="Центр слуха в Томске: как проходит подбор аппарата, почему к нам обращаются, ответы на частые вопросы."
        path="/about"
      />
      <PageHero
        crumbs={[{ label: 'О центре' }]}
        eyebrow="О нас"
        title="Центр слуха в Томске"
        text="Проверяем слух, подбираем и настраиваем аппараты, ремонтируем и обслуживаем их в своей мастерской. Работаем с людьми, а не с диагнозами: объясняем понятным языком и не продаём лишнего."
      />
