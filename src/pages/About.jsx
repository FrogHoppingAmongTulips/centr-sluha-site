  ...
  return (
    <>
      <PageHero
        ...
        title="Молодой центр слуха с опытными врачами"
        text="«Вектор» — новый центр, но за ним стоят сурдологи и сурдопедагоги с многолетним стажем. Мы открылись, чтобы вернуть людям слух, общение и уверенность — честно и без лишних продаж."
      />
        ...
        <div className="container about-split">
          <Reveal className="about-split__text">
            ...
            <div className="about-values">
              <span><Icon name="shield" size={18} /> Работаем по медицинской лицензии</span>
              <span><Icon name="ear" size={18} /> Аппараты 5 ведущих брендов</span>
              <span><Icon name="home" size={18} /> Бесплатная первая проверка слуха</span>
            </div>
          </Reveal>
