  ...
  return (
    <article className="pcard">
      <Link to={`/catalog/${item.slug}`} className="pcard__media">
        ...
        {item.tag && <span className="tag tag--accent pcard__tag">{item.tag}</span>}
      </Link>
      <div className="pcard__body">
        ...
        <div className="pcard__actions">
          <button className="btn btn-primary btn-sm" onClick={() => openForm('visit', item.slug)}>Записаться</button>
