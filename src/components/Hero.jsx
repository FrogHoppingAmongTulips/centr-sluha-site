  ...
  return (
    <section className="hero">
      <div className="container hero__inner">
        <span className="eyebrow">Центр слуха в Краснодаре</span>
        <h1>Слышать - это просто</h1>
        <p>
          Проверяем слух, подбираем и настраиваем слуховые аппараты. Тест слуха бесплатный:
          сначала разбираемся, что со слухом, и только потом говорим об аппарате. Если добраться
          сложно — специалист приедет на дом.
        </p>
